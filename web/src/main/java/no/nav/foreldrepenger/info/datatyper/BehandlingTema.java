...
import static no.nav.foreldrepenger.info.datatyper.FagsakYtelseType.ENDRING_FP;
import static no.nav.foreldrepenger.info.datatyper.FagsakYtelseType.ES;
import static no.nav.foreldrepenger.info.datatyper.FagsakYtelseType.FP;
import static no.nav.foreldrepenger.info.datatyper.FamilieHendelseType.ADOPSJON;
import static no.nav.foreldrepenger.info.datatyper.FamilieHendelseType.FØDSEL;
import static no.nav.foreldrepenger.info.datatyper.FamilieHendelseType.OMSORGOVERDRAGELSE;
import static no.nav.foreldrepenger.info.datatyper.FamilieHendelseType.TERMIN;
